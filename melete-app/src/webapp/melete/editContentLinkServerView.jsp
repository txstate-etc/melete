...
{
	var url = document.getElementById("EditServerViewForm:link").value;
         ...
         <tr>
          	<td>
		    	<div class="actionBar" align="left">
					<h:commandButton id="return" actionListener="#{editSectionPage.returnBack}"  value="#{msgs.im_return}" accesskey="#{msgs.return_access}" title="#{msgs.im_return_text}" styleClass="BottomImgReturn" onclick="return validateUrl();">
					</h:commandButton>
   	        	</div>
			  </td>
            </tr>
